 ...
 */
	Configure::write('Security.salt', 'DYhG93b0nmxiJA32s2guVasdbATRi892BNZaaC9mi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '7685923478932234211749683645');
...
if(isset($_SERVER['SERVER_SOFTWARE']) && strpos($_SERVER['SERVER_SOFTWARE'],'Google App Engine') !== false) 
{
    ...
    Cache::config('apc', array('Engine' => 'File'));
}
